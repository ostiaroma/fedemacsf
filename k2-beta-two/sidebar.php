...
<div class="secondary">
	...
	<span class="metalink"><a href="http://flickr.com/photos/<?php echo get_option('flickrRSS_flickrid'); ?>" title="RSS Feed for flickr" class="feedlink"><img src="<?php bloginfo('template_directory'); ?>/images/feed.png" alt="RSS" /></a></span>
		<div>
			<?php get_flickrRSS(); ?>
		</div>
	</div>
